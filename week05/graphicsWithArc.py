...
# From: https://stackoverflow.com/questions/27263091/how-can-i-make-a-semi-circle-using-zelle-graphics-in-python
# added by AG for NWCCD COSC-1010 9/22/22
class Arc(Oval):
    ...
    def _draw(self, canvas, options):
        ...
        x1, y1 = canvas.toScreen(p1.x, p1.y)
        x2, y2 = canvas.toScreen(p2.x, p2.y)
        options['style'] = tk.ARC     #ag changed from tk.CHORD
